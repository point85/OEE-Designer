...
## What's New
In version 3.5.0, HTTP APIs were added to get OEE event records and the corresponding OEE calculations.  Please see the Release Notes.txt file for release history.
