...
public class LeaderBoardItem extends Region implements Comparable<LeaderBoardItem> {
	...
	@Override
	public int compareTo(final LeaderBoardItem SEGMENT) {
		return Double.compare(getValue(), SEGMENT.getValue());
	}
	...
	public void setOnChartDataEvent(final ChartDataEventListener LISTENER) {
		chartData.addChartDataEventListener(LISTENER);
	}
	...
	public void removeChartDataEventListener(final ChartDataEventListener LISTENER) {
		chartData.removeChartDataEventListener(LISTENER);
	}
